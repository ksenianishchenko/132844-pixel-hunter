...
const elementStats = (state) => {
  ...
  <div class="result">
    ...
    <table class="result__table">
      ...
      <tr>
        <td colspan="5" class="result__total  result__total--final">${state.points + state.lives * 50}</td>
      </tr>
    </table>
    <table class="result__table">
      <tr>
  ...
  const statsScreen = createDomElement(article);
  const buttonBack = statsScreen.querySelector(`.back`);
