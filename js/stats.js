...
export default class StatsScreenTemplate extends AbstractView {
    ...
    <div class="result">
      ...
      <table class="result__table">
        <tr>
          ...
          <td class="result__total">${this.game.points}</td>
        </tr>
        <tr>
          <td></td>
        ...
        <tr>
          <td colspan="5" class="result__total  result__total--final">${this.game.points + this.game.lives * 50}</td>
        </tr>
      </table>
      <table class="result__table">
        <tr>
